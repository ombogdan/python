...
w = (x_max_result - x_min_result) / 9.554628536 * 3
h = (y_max_result - y_min_result) / 9.554628536 * 3
...
for i in range(len(arr)):
    x_mx = x_min + (arr[i][0] / 3) * 9.554628536
    y_mx = y_min + ((h - 2 * 9.554628536) / 3 * 9.554628536) - (arr[i][1] / 3) * 9.554628536
    # print(x_mx, y_mx)
    x = x_mx
    y = y_mx
